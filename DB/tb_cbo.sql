...
--
-- Servidor: localhost
-- Tempo de Geração: 24/06/2017 às 12:14:34
...
CREATE TABLE IF NOT EXISTS `tb_cbo` (
  `COL 1` varchar(6) DEFAULT NULL,
  `COL 2` varchar(140) DEFAULT NULL
...
INSERT INTO `tb_cbo` (`COL 1`, `COL 2`) VALUES
('CODIGO', 'TITULO'),
...
('773410', 'Operador de máquina de cortina dŽágua (produção de móveis)'),
